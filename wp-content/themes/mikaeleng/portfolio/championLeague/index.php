...
<script type="text/javascript" src="js/swfobject.js"></script>
		<script type="text/javascript">
			...
			var xiSwfUrlStr = "";
			var flashvars = {};
			flashvars.xmlpath = "xml/mainStructure.xml";
			flashvars.swfpath ="";
			flashvars.sharepath = "http://www.sonyericsson.com/clcompetition/facebook/shareSE.html";
			flashvars.moviepath = "movies/";
			flashvars.soundpath = "";
			flashvars.gaaccount = "UA-21165699-1";
			flashvars.gamode = "AS3";
			flashvars.gadebug = "false";
			var params = {};
			params.quality = "high";
			...
			var attributes = {};
			attributes.id = "siteContent";
			attributes.name = "siteContent";
			attributes.align = "middle";
			swfobject.embedSWF(
				"ChampionsLeague.swf", "siteContent",
				"838", "591",

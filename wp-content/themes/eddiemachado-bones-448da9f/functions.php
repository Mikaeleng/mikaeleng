...
function your_custom_menu_item ( $items, $args ) {
    //if( $args->theme_location == 'primary' ){
         ...
         return  '<li id="mobile-menu-item-search" class="class-menu-item class-menu-item-type-custom class-menu-item-object-custom class-current-menu-item class-menu-item-search">' . bones_wpsearch($form) . '</li>'. $items .'<li id="menu-item-search" class="class-menu-item class-menu-item-type-custom class-menu-item-object-custom class-current-menu-item class-menu-item-search">' . bones_wpsearch($form) . '</li>';
    //}
    //return $items;
}
/************* ACTIVE SIDEBARS ********************/
...
function add_to_head(){
    ...
    <!-- <link rel="stylesheet" type="text/css" href="<?php echo get_sitepath(); ?>wp-content/themes/eddiemachado-bones-448da9f/library/css/event.css" />-->
   	<script src="<?php echo get_sitepath(); ?>wp-content/themes/eddiemachado-bones-448da9f/library/js/db-script.js" type="text/javascript">  </script>
    <?php
  }
	/*if(is_front_page()){
